...
//   // Loading skeleton – matches the theme
//   if (loading) {
//     return (
...
//   return (
//     <section className="relative w-full bg-white py-10 md:py-15 lg:py-18" id="project">
//       <div className="max-w-7xl mx-auto px-4 md:px-8">
...
//         {/* Swiper – with consistent spacing and styling */}
//         <Swiper
//           modules={[Autoplay, Pagination]}
//           spaceBetween={24}
//           slidesPerView={1}
...
//           {cardsData.map((card) => (
//             <SwiperSlide key={card._id || card.id}>
//               <div className="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 h-full">
//                 {/* Image – 16:9 with smooth hover zoom */}
//                 <div className="relative w-full aspect-[16/9] bg-gray-100 overflow-hidden rounded-t-2xl">
//                   <img
//                     src={`/uploads/projects/${card.image}`}
//                     alt={card.title}
//                     className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
//                   />
//                   {/* Overlay (same subtle gradient as hero blobs) */}
...
//         {/* View All – matches the hero’s secondary button style */}
//         <div className="mt-12 text-center">
//           <button
//             onClick={() => navigate("/projects")}
//             className="inline-flex items-center gap-2 px-8 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-full font-semibold hover:bg-gray-100 hover:border-gray-400 transition-all duration-300 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
//           >
//             View All Projects
//             <svg
//               className="w-4 h-4"
