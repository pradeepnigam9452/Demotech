      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white/70 backdrop-blur-md border border-white/30 rounded-3xl p-6 md:p-8 shadow-xl shadow-blue-100/50">
          ...
          <p className="mt-1 text-sm text-gray-600 ml-1">
            Apply for leave and check whether your request is pending, approved, or rejected.
          </p>
        </div>

        {/* ===== Stats – Pastel Cards ===== */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition group">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition group">
            <div className="flex items-center justify-between">
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition group">
            <div className="flex items-center justify-between">
        ...
        {/* ===== Main Grid ===== */}
        <div className="grid lg:grid-cols-3 gap-6">
          {/* ===== Apply Leave Form – Glassmorphism ===== */}
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200/80 p-6 shadow-sm lg:col-span-1">
            ...
            <form onSubmit={applyLeave} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full mt-1 border border-gray-200/80 bg-white/60 backdrop-blur-sm rounded-xl p-3 outline-none focus:ring-2 focus:ring-blue-400 text-gray-700"
                >
                  <option value="">Select Leave Type</option>
                  <option value="Casual Leave">Casual Leave</option>
                  <option value="Sick Leave">Sick Leave</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  placeholder="Write your leave reason..."
                  className="w-full mt-1 border border-gray-200/80 bg-white/60 backdrop-blur-sm rounded-xl p-3 outline-none focus:ring-2 focus:ring-blue-400 resize-none text-gray-700"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 py-3 rounded-xl font-bold flex items-center justify-center gap-2 border border-blue-200 transition disabled:opacity-60 disabled:cursor-not-allowed hover:border-blue-300"
              >
                {loading ? (
                  <>
                    <Loader2 className="w-5 h-5 animate-spin" />
              ...
              {message && (
                <p className="text-sm font-semibold text-blue-600 text-center bg-blue-50/80 border border-blue-200 rounded-xl p-2">
                  {message}
                </p>
              )}
            </form>
          ...
          {/* ===== Leave Requests List – Glassmorphism ===== */}
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden lg:col-span-2">
            ...
            {fetching ? (
              ...
              <div className="divide-y divide-gray-200/50">
                {leaves.map((leave) => (
                  <div key={leave._id} className="p-5 hover:bg-white/30 transition-colors">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                      <div>
                        <h3 className="font-bold text-gray-800">
                          {leave.leaveType}
                        ...
                        {leave.adminRemark && (
                          <div className="mt-3 bg-gray-50/80 border border-gray-200/60 rounded-xl p-3">
