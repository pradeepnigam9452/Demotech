        ...
        {projects.map((project) => (
          <div key={project._id} className="bg-white rounded-xl shadow p-4 relative">
            ...
            <p className="text-sm mt-2">
              <span className="font-semibold">Features:</span> {project.features.join(', ')}
            </p>
            <a
              href={project.link}
            ...
            <div className="absolute top-4 right-4 group">
              ...
              <div className="hidden group-hover:block absolute right-0 bg-white border shadow rounded text-sm">
                <button
