...
//   return (
//     <section className="relative min-h-screen overflow-hidden bg-white px-4 py-10 md:px-8 lg:px-10">
//       <motion.div
...
//             onClick={() => handleStatCardClick("allOpenings")}
//           />
...
//             onClick={() => handleStatCardClick("internships")}
//           />
...
//           initial={{ opacity: 0, y: 22 }}
//           animate={{ opacity: 1, y: 0 }}
//           className="mb-8 flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:flex-row"
//         >
//           <button
//             onClick={() => setShowCreateModal(true)}
//             className="flex items-center justify-center gap-2 rounded-full bg-[#378af9] px-6 py-3 font-semibold text-white shadow-md shadow-blue-200/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
//           >
...
//               setShowOpeningsModal(true);
//             }}
//             className="flex items-center justify-center gap-2 rounded-full bg-gray-900 px-6 py-3 font-semibold text-white shadow-md transition-all duration-300 hover:scale-[1.02] hover:bg-[#378af9]"
//           >
...
//                 className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition hover:bg-red-500 hover:text-white"
//               >
//                 <X className="h-5 w-5" />
//               </button>
//             </div>
...
//       <AnimatePresence>
//         {showOpeningsModal && (
//           <ModalWrapper onClose={() => setShowOpeningsModal(false)} size="large">
//             <div className="mb-5 flex items-center justify-between gap-4">
//               <div className="flex items-center gap-3">
//                 <div className="flex h-11 w-11 items-center justify-center rounded-full bg-blue-100">
//                   <ListChecks className="h-5 w-5 text-[#378af9]" />
//                 </div>
...
//               <button
//                 onClick={() => setShowOpeningsModal(false)}
//                 className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition hover:bg-red-500 hover:text-white"
//               >
//                 <X className="h-5 w-5" />
//               </button>
...
// const ModalWrapper = ({ children, onClose, size = "normal" }) => {
//   return (
//     <motion.div
...
//         className={`max-h-[90vh] w-full overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl md:p-8 ${
//           size === "large" ? "max-w-5xl" : "max-w-3xl"
//         }`}
//       >
//         {children}
//       </motion.div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-8 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-5">
          ...
          <StatCard
            ...
            onClick={() => handleStatCardClick("allApplications")}
          />

          <StatCard
            icon={<FileText />}
            title="Internship Requests"
            value={stats.internshipRequests}
            onClick={() => handleStatCardClick("internshipRequests")}
          />
        </div>
